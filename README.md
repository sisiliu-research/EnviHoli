...
4. Taxonomic reference dump files used for classification are archived on Zenodo (DOI: 10.5281/zenodo.17974857)
...
### VI. Example: Filtering and aggregating taxonomic data
1. This example tutorial illustrates the structure and content of the RData output generated by bash_scripts/08-combine_lca.sh, and demonstrates basic filtering and aggregation operations to facilitate downstream reuse.
