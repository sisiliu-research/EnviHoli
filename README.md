...
### VI. Filtering and aggregating taxonomic data
1. A practical guide to filtering and aggregating taxonomic R data generated by bash_scripts/08-combine_lca.sh is provided in taxonomic-data-tutorial/FilteringAggregatingTaxonomicData.R.
